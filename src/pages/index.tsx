  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience effortless employee management with HR Information System: Your one-stop solution for data management, vacation tracking, and payroll processing."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience effortless employee management with HR Information System: Your one-stop solution for data management, vacation tracking, and payroll processing.`}
            </Text>
            <Box
